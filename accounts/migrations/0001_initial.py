    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='accounts/images/carton.png', null=True, upload_to='', verbose_name='accounts/images/%Y/%m/%d/%H/%M/%S/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('otp', models.CharField(default='27e5a', max_length=6)),
